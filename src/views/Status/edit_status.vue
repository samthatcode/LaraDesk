          ...
          <div class="dashboard">
            ...
            <v-row class="bg-white pa-4">
              ...
              <v-col cols="4">
                ...
                <p>Status details and customization.</p>
              </v-col>
                ...
                <v-row>
                  <v-col>
                    <div class="input-section">
                        <label for="status-title" class="input-label">Name</label>
                        <v-text-field id="status-title" v-model="statusTitle" class="input-field" />
                    </div>
                  </v-col>
                </v-row>
              </v-col>
            ...
            <v-row class="pt-6">
              <v-col class="d-flex justify-end">
                ...
                <v-btn color="success" class="ml-4" @click="editStatus">Edit status</v-btn>
              </v-col>
            </v-row>
          </div>
        </v-container>
  ...
  export default {
    ...
    created() {
        if (this.$route.query.status) {
          this.statusTitle = this.$route.query.status;
        }
    },
    methods: {
        async logout() {
      ...
      cancel() {
        ...
        toast.info('Status edit canceled', {
          type: 'info',
          timeout: 3000,
        });
        this.$router.push('/dashboard/admin/status');
      },
      async editStatus() {
        const toast = useToast()
        try {
